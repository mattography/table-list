...
angular.module('myApp.services', [])
  .value('FIREBASE_URL', 'https://waitandeat-alter.firebaseio.com/')
  ...
  .factory('textMessageService', function(dataService, partyService) {
    ...
    var textMessageServiceObject = {
      sendTextMessage: function(party, userId) {
        ...
        partyService.getPartiesByUserId(userId).$child(party.$id).$update({notified: 'Yes', notifiedTime: new Date()});
      }
    };
